...
- **勉強モード**: ひらがな・カタカナを選び、書き順アニメーションを見ながら各文字を5回書く
- **学習記録**: 文字種を切り替えて進捗を確認し、習得済み状態を手動で設定・解除してLocalStorageに保存
- **韓国語UI**: 操作文言を韓国語で表示

ひらがなとカタカナの清音各46文字、合計92文字に対応しています。
...
- **LocalStorage**: `version` フィールド付き。既存のひらがな記録を維持し、v3でカタカナ記録を追加する
